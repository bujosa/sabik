...
describe('Contract', function () {
  ...
  describe('after creating a user', () => {
    ...
    it('should return the user', async () => {
      ...
      assert(
        user.isActive,
        'Expected a new User to have an isActive boolean that returns true.'
      );
    });
    ...
    it('should not allow the same address to create another user', async () => {
      ...
      assert(
        ex,
        'The same address should not be able to invoke createUser twice. Expected transaction to revert!'
      );
    });
